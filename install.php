<?php
    ...
    if( isset( $_POST['dbserver'] ) ) {
        ...
        $validationData = Validator::check([
            'dbserver' =>   [ $_POST['dbserver'],   "/[A-Za-z0-9\.\-_]{8,64}/" ],
            'dbport' =>     [ $_POST['dbport'],     "/[0-9]{3,5}/" ],
            'dbname' =>     [ $_POST['dbname'],     "/[A-Za-z0-9\-_]{4,16}/" ],
            'dbuser' =>     [ $_POST['dbuser'],     "/[A-Za-z0-9\-]{4,16}/" ],
            'dbpassword' => [ $_POST['dbpassword'], "/[A-Za-z0-9\-_]{8,32}/" ]
        ]);
...
<html lang="en">
  ...
  <body class="bg-light">
        <div class="w-100 h-100 d-flex align-items-center justify-content-center">
            <div id="install_form" class="col-12 col-md-6 col-lg-4 bg-dark rounded text-white p-3">
                ...
                <form method="POST" action="install.php" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input value="<?= htmlspecialchars(strval($_POST['dbserver'])); ?>" type="text" class="form-control" id="dbserver" name="dbserver" placeholder="localhost" required pattern="[A-Za-z0-9\.\-_]{8,64}">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="<?= htmlspecialchars(strval($_POST['dbport'])); ?>" type="text" class="form-control" id="dbport" name="dbport" placeholder="3306" required pattern="[0-9]{3,5}">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="<?= htmlspecialchars(strval($_POST['dbname'])); ?>" type="text" class="form-control" id="dbname" name="dbname" required pattern="[A-Za-z0-9\-_]{4,16}">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="<?= htmlspecialchars(strval($_POST['dbuser'])); ?>" type="text" class="form-control" id="dbuser" name="dbuser" placeholder="administrator" required pattern="[A-Za-z0-9\-]{4,16}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="dbpassword" name="dbpassword" required pattern="[A-Za-z0-9\-_]{8,32}">
